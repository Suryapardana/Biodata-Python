...
print("\033[1;94m*         *    **     *           *      [ https://github.com/Suryapardana] ")
print("\033[1;94m*         *    **     *           *      
print("\033[1;94m*         *    **     *           *  ")
print("\033[1;94m**********     **     *           * ")
print("\033[1;94m*         *    **     *           * ")
...
teks = "\nNama Lengkap: {}\nUmur: {}\nJenis Kelamin: {}\nTempat/tanggal lahir: {}\nAlamat: {}\nAgama: {}\nTinggi badan: {}\nRiwayat penyakit: {}\nHobi: {}\nPekerjaan: {}\nTlp {}\n-----------------".format(nama_lengkap, umur, jenis_kelamin, tempat_tanggal_lahir, alamat, agama, tinggi_badan, riwayat_penyakit, hobi, pekerjaan, tlp)
